...
(() => {
    ...
    function fitCamera(initial = false) {
        ...
        const mobileCameraY = mobile ? garmentMaxSize * 0.38 : garmentMaxSize * 0.015;
        const targetY = mobile ? garmentMaxSize * 0.66 : garmentMaxSize * 0.025;
    ...
    function mobileFrameScale() {
        ...
        return compactMedia.matches ? 0.82 : 1;
    }
