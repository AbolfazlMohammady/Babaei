...
from .views import CategoryDetailView, ProductCommentAddView, ProductCommentsView, ProductDetailView, ShopIndexView, ShopSearchView
...
urlpatterns = [
    ...
    path("search/", ShopSearchView.as_view(), name="search"),
