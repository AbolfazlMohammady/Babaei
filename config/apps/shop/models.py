...
class Category(models.Model):
    ...
    image = models.ImageField(_("تصویر"), upload_to="shop/categories/%Y/%m/", blank=True, null=True)

    is_active = models.BooleanField(_("فعال"), default=True, db_index=True)
    sort_order = models.PositiveIntegerField(_("ترتیب"), default=0, db_index=True)
...
class ProductColor(models.Model):
    ...
    hex_code = models.CharField(_("کد رنگ"), max_length=7, blank=True)
    is_active = models.BooleanField(_("فعال"), default=True, db_index=True)
...
class ProductSize(models.Model):
    ...
    sort_order = models.PositiveSmallIntegerField(_("ترتیب"), default=0, db_index=True)
    is_active = models.BooleanField(_("فعال"), default=True, db_index=True)
...
class ProductImage(models.Model):
    ...
    image = models.ImageField(_("تصویر"), upload_to="shop/products/%Y/%m/", max_length=500)
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=("product", "image_type", "sort_order")),
        ]
