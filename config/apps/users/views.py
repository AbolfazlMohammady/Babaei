...
def address_create_view(request):
    ...
    return render(request, "users/account/address_form.html", {"cities": cities})
...
def address_update_view(request, pk):
    ...
    cities = City.objects.select_related("province").order_by("province__name", "name")
    return render(request, "users/account/address_form.html", {"address": address, "cities": cities})
